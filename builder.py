...
def get_identity():
    """Try to get identity from auth.db, fallback to fake auth for local servers."""
    try:
        query = (
        ...
        pass
    # Fallback to fake auth for local servers
    return ('builder', 'fake_token')
...
def clear_pixel_wall(set_block, sx, sy, sz, cols, row_count, pad_x=2, pad_y=2, pad_z=1):
    """Remove stone/plank from a bitmap-sized xy slab (constant sz, rows along -y)."""
    for dz in range(-pad_z, pad_z + 1):
        for dy in range(-pad_y, row_count + pad_y):
            y = sy - dy
            for dx in range(-pad_x, cols + pad_x):
                set_block(sx + dx, y, sz + dz, EMPTY)
...
def main():
    ...
    # Optional demo scaffold (skipped by default: collides with existing terrain).
    ...
    # ETHAN & EVA (5x7 font, 2-col gaps; 11 glyphs -> 75 cols/row)
    data = [
        'xxxxx..xxxxx..x...x....x....x...x..........xx...........xxxxx..x...x....x..',
        'x........x....x...x...x.x...xx..x.........x..x..........x......x...x...x.x.',
        'x........x....x...x..x...x..x.x.x.........x..x..........x......x...x..x...x',
        'xxx......x....xxxxx..x...x..x..xx..........xx...........xxx....x...x..x...x',
        'x........x....x...x..xxxxx..x...x.........x.x...........x.......x.x...xxxxx',
        'x........x....x...x..x...x..x...x.........x..x..........x.......x.x...x...x',
        'xxxxx....x....x...x..x...x..x...x..........xx.x.........xxxxx....x....x...x',
    ]
    lookup = {
        'x': STONE,
        '.': PLANK,
    ...
    cols = len(data[0])
    row_count = len(data)
    # Wipe old sky placement (was y=72, z=0; often inside clouds).
    clear_pixel_wall(set_block, 0, 72, 0, max(cols, 72), row_count)
    # Original builder spot: xy wall at z=32, top row y=32 (near spawn, below clouds).
    sx, sy, sz = 0, 32, 32
    clear_pixel_wall(set_block, sx, sy, sz, max(cols, 72), row_count)
    client.bitmap(sx, sy, sz, (1, 0, 0), (0, -1, 0), data, lookup)

    print("Pixel art sent. Draining replies for 8s, then disconnect.")
